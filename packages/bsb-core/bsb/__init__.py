...
def _get_annotation_submodule(name: str):
    annotation = sys.modules[__name__].__annotations__.get(name, None)
    if annotation:
...
@functools.cache
def __dir__():
    return [*sys.modules[__name__].__annotations__.keys()]
...
AfterPrepareHook: type["bsb.simulation.postprocessing.AfterPrepareHook"]
...
DistributionPlacement: type["bsb.placement.random.DistributionPlacement"]
...
LabellingError: type["bsb.exceptions.LabellingError"]
...
decode_annotation: "bsb.storage.provenance.decode_annotation"
discover: "bsb.plugins.discover"
discover_engines: "bsb.storage.discover_engines"
encode_annotation: "bsb.storage.provenance.encode_annotation"
...
resolve_seed: "bsb.rng.resolve_seed"
