...
if typing.TYPE_CHECKING:  # pragma: nocover
    from ..services.pool import PoolExecutor
...
class JobPool:
    ...
    def __init__(self, id, scaffold, fail_fast=False, workflow: "Workflow" = None):
        ...
        self._mpipool: "PoolExecutor | None" = None
    ...
    def _execute_parallel(self):
        ...
        # Create the parallel pool through the configured pool provider.
        self._mpipool = Pool(
            loglevel=logging.DEBUG if bsb.options.debug_pool else logging.CRITICAL,
            debug=bool(bsb.options.debug_pool),
        )
